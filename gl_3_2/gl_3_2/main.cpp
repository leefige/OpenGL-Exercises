...
int main()
{
	...
	// create a window
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "OpenGL Tutorial 3.2: Draw Mixed-color Triangle", nullptr, nullptr);
	if (window == nullptr) {
	...
	while (glfwWindowShouldClose(window) == 0) {
		...
		const GLuint shifting = glGetUniformLocation(shaderProgram, "shifting");
		glUniform1f(shifting, sinf(timeval) / 2 + 0.5);
